...
from .deps import (
    oauth2_scheme,
    _utcnow_naive,
    _get_primary_membership,
    _build_user_session_payload,
    _issue_user_session_tokens,
    _attach_user_household_context,
    _authenticate_api_key_user,
    _normalize_household_role,
    _is_room_admin,
    _get_current_household_or_404,
    get_current_user,
    get_admin_user,
    get_account_admin_user,
)
...
# _get_primary_membership, _build_user_session_payload, _issue_user_session_tokens,
# _attach_user_household_context — moved to deps.py
...
# _utcnow_naive — moved to deps.py
...
# _normalize_household_role, _is_room_admin — moved to deps.py
...
# _get_current_household_or_404 — moved to deps.py
...
# _authenticate_api_key_user, get_current_user, get_admin_user,
# get_account_admin_user — moved to deps.py
