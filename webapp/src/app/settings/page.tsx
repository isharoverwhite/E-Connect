            ...
            <aside className="w-64 bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800 flex flex-col hidden md:flex z-20 shadow-lg">
                ...
                <div className="flex-1 overflow-y-auto py-4">
                    <nav className="px-4 space-y-1">
                        ...
                        <button onClick={() => router.push('/logs')} className="w-full flex items-center px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white rounded-lg transition-colors text-left">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-y-auto">
                <div className="p-8">
                    ...
                    <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-8 flex flex-col items-center justify-center text-center">
                        <span className="material-icons-round text-4xl text-slate-400 mb-4">settings</span>
                        <h2 className="text-xl font-semibold mb-2 text-slate-900 dark:text-white">System Configuration</h2>
                        <p className="text-slate-500 max-w-md">Global hub settings, user management, and network configuration will appear here.</p>
                    </div>
                </div>
            </main>
        </div>
